...
![Create.js with Hallo Editor](https://s3.eu-central-1.amazonaws.com/bergie-iki-fi/createjs-editors/hallo.png)

Aloha Editor:

![Create.js with Aloha Editor](https://s3.eu-central-1.amazonaws.com/bergie-iki-fi/createjs-editors/aloha.png)

CKEditor:

![Create.js with CKEditor](https://s3.eu-central-1.amazonaws.com/bergie-iki-fi/createjs-editors/ckeditor.png)

Redactor:

![Create.js with Redactor](https://s3.eu-central-1.amazonaws.com/bergie-iki-fi/createjs-editors/redactor.png)
...
![Editing text](https://s3.eu-central-1.amazonaws.com/bergie-iki-fi/createjs-ui-2013-editing.png)
...
![Editing geolocation](https://s3.eu-central-1.amazonaws.com/bergie-iki-fi/createjs-ui-2013-metadata.png)
...
![Adding items](https://s3.eu-central-1.amazonaws.com/bergie-iki-fi/createjs-ui-2013-create.png)
